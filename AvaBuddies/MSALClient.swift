...
class MSALClient: NSObject, URLSessionDelegate {
    ...
    private func createContext() -> (result: Bool, description: String) {
        do {
            ...
            self.applicationContext = try MSALPublicClientApplication(clientId: Constants.MSAL.ClientID, authority: authority)
    ...
    private func acquireTokenInteractively() {
        ...
        applicationContext.acquireToken(forScopes: Constants.MSAL.Scopes) { (result, error) in
    ...
    private func acquireTokenSilently() {
        ...
        applicationContext.acquireTokenSilent(forScopes: Constants.MSAL.Scopes, account: self.currentAccount()!) { (result, error) in
    ...
    private func getContentWithToken() {
        ...
        let url = URL(string: Constants.MSAL.GraphURI)
