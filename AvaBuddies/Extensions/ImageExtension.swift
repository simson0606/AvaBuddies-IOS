...
//  AvaBuddies
//
//  Created by simon heij on 12/04/2019.
...
extension UIImage {
    ...
    func resizeCropImage(targetSize: CGSize) -> UIImage {
        return resizeImage(targetSize: targetSize).cropImage(targetSize: targetSize)
    }
